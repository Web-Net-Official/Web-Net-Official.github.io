...
function showResult(str) {
  ...
  xmlhttp.open("GET","livesearchb.php?q="+str,true);
  xmlhttp.send();
}
</script>
...
error_reporting(0);
    $pages = simplexml_load_file('b.xml');
...
?>
						<!--	<div class="col-sm-6 col-md-3">
							...
							<div class="col-sm-6 col-md-3">
								<div class="latest-movie">
									<a href="https://openload.co/embed/YOooXZEhnkQ"><img src="dummy/ChaalBaaz.jpg" alt="Movie 27"></a>
								</div>
							</div>
							<div class="col-sm-6 col-md-3">
								<div class="latest-movie">
									<a href="https://www.youtube.com/embed/CEkOp5PLALY"><img src="dummy/judaai.jpg" alt="Movie 28"></a>
								</div>
							</div>
							<div class="col-sm-6 col-md-3">
								<div class="latest-movie">
									<a href="https://www.youtube.com/embed/ds1MDZ8ng9Y"><img src="dummy/laadla.jpg" alt="Movie 31"></a>
								</div>
							</div>
							<div class="col-sm-6 col-md-3">
								<div class="latest-movie">
									<a href="https://www.youtube.com/embed/GmUCKb7HKmc"><img src="dummy/deewana.jpg" alt="Movie 32"></a>
								</div>
							</div>-->
						</div> <!-- .row -->
