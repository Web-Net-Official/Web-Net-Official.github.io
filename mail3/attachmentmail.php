...
<body>
<center>
<h1><font face="caliph">Khatara Gourmet</font></h1>
</center>
<div class="container">
 <form action="email.php" enctype="multipart/form-data" method="post">
   <label for="toemail">To Email <font color="red"><b>*</b></font></label>
    ...
    <label for="attach">Attachment <font color="red"><b>*</b></font></label><br>
    <input type="file" name="fileatt" placeholder="Attach a file..." required>
	<br><br>
